...
def send_message():
    ...
    chatbot_response = "Hola, soy un chatbot. Gracias por tu mensaje: "

    chatbot_response = ""
    print(user_message)
    print( jsonify({'message': check_all_messages(user_message)}))
    print(get_response(user_message))

    return jsonify({'message': get_response(user_message)})
